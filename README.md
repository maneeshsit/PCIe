# PCIe
Open Source alternative to run.ai code for using a PCIe-based AI accelerator (such as a GPU, FPGA, or ASIC like NVIDIA, AMD, Xilinx, Intel accelerators, and others) for both inference and training
