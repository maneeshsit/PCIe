# PCIe
Open Source code for using PCIe-based AI accelerators (support for PCIe-based AI accelerators such as GPUs, FPGAs, ASICs from NVIDIA, AMD, Xilinx, Intel, and more) for both inference and training. Democratizing access to multimodal large language models, proving that accessing high-performance LLM inference is achievable beyond centralized data centers and on the hardware people already own or plan to own.
